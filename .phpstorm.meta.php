...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Domain\Users\Repositories\UserRepositoryInterface' => \App\Infrastructure\Persistence\EloquentUserRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/checqUp-tech-task/public/storage' => 'string',
            'l5-swagger.default' => 'string',
            'l5-swagger.documentations.default.api.title' => 'string',
            'l5-swagger.documentations.default.api.description' => 'string',
            'l5-swagger.documentations.default.api.version' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/checqUp-tech-task/public/storage',
'l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.api.description','l5-swagger.documentations.default.api.version','l5-swagger.documentations.default.routes.api',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','users.index','users.store','users.show','users.update',
'users.destroy','storage.local',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','L5_SWAGGER_CONST_HOST',);
